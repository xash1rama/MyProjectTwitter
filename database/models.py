from sqlalchemy import Column, Integer, String, LargeBinary, ForeignKey, ARRAY
...
class User(Base):
    ...
    follower = relationship("Follower", back_populates="user_follower", lazy="select", cascade="all")
    following = relationship("Follower", back_populates="user_following", lazy="select", cascade="all")
    tweet = relationship("Tweet", back_populates="user_tweet", lazy="select", cascade="all")
...
class Tweet(Base):
    ...
    tweet_media = relationship("Media", back_populates="media_tweet", lazy="select", cascade="all")
