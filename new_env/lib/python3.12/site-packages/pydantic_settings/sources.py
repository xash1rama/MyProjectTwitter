...
class PydanticBaseEnvSettingsSource(PydanticBaseSettingsSource):
    ...
    def _extract_field_info(
        ...
        if not v_alias or self.config.get("populate_by_name", False):
            if origin_is_union(get_origin(field.annotation)) and _union_is_complex(
...
class CliSettingsSource(EnvSettingsSource, Generic[T]):
        ...
        for field_name, field_info in self._sort_arg_fields(model):
            ...
            if _CliSubCommand in field_info.metadata:
                ...
                kwargs["help"] = self._help_format(
                    field_name, field_info, model_default
                )
    ...
    def _help_format(
        self, field_name: str, field_info: FieldInfo, model_default: Any
    ) -> str:
...
class AzureKeyVaultSettingsSource(EnvSettingsSource):
    ...
    def __repr__(self) -> str:
        return (
            f"{self.__class__.__name__}(url={self._url!r}, "
